...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>ETARA - Подтверждение заказа</title>
	...
	<body lang="en">
                ...
                <div id="main">	
                  <div class="wrapper clearfix">
                    <h2 class="page-heading"><span>ПОДТВЕРЖДЕНИЕ ЗАКАКАЗА</span></h2> 
                ...
                <?php
                  ...
                  if (isset($_POST['submit'])) {
                    if ($_POST['confirm'] == 'Yes') {
                      ...
                      echo '<p>Заказ на ' . $name .  ' был успешно подтвержден.';
                    }
                    else {
                      echo '<p class="error">Заказ не был подтвержден.</p>';
                    }
                  }
                  else if (isset($order_id) && isset($name) && isset($description) && isset($cost) && isset($date)) {
                    echo '<p>Вы уверены, что хотите подтвердить заказ №' . $order_id . ' ?</p>';
                      ...
                      echo '<form method="post" action="orderapprove.php?order_id=' . $order_id .  '&amp;name='. $name .'">';    
