...
<html class="no-js">
	...
	<head>
		<meta charset="utf-8"/>
		<title>ETARA - Удаление заказа</title>
                ...
                <?php
                  ...
                  <div id="main">	
                    <div class="wrapper clearfix">
                      <h2 class="page-heading"><span>ПОДТВЕРЖДЕНИЕ ИСПОЛНЕНИЯ</span></h2> 
                  ...
                  <?php
                    ...
                    if (isset($_POST['submit'])) {
                      if ($_POST['confirm'] == 'Yes') {
                        ...
                        $query = "UPDATE orders SET archive = 1 WHERE order_id = $order_id";
                        mysqli_query($dbc, $query);
                        mysqli_close($dbc);

                        echo '<p>Заказ на '. $name .' был успешно удалён.';
                      }
                      else {
                        echo '<p class="error">Заказ не был удалён.</p>';
                      }
                    }
